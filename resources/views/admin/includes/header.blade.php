    ...
    <div class="top-bar">
        ...
        <div class="top-bar-brand">
            ...
            <a href="{{ route('admin.index') }}">
                <img src="{{asset('admin/images/dia-chi-co-quan-bao-hiem-xa-hoi-thi-xa.png')}}" style="width: 99px;margin-left: 30px;">
            </a>
        </div><!-- /.top-bar-brand -->
        <!-- .top-bar-list -->
        <div class="top-bar-list">
            ...
            <div class="top-bar-item top-bar-item-full">
                <form action="{{ route('insurances.index')}}" method="get" style="width: 100%;">
